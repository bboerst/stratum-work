      ...
      <div className="w-full max-w-7xl">
        ...
        <div className="w-full border border-gray-300 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-900">
          ...
          <details className="mt-6">
            ...
            <textarea
              className="w-full h-[300px] font-mono text-sm p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
